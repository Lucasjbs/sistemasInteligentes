...
public class Modelo {
    ...
    ArrayList<Integer> X_interacao = new ArrayList<>();
    ArrayList<Double> Y_custo = new ArrayList<>();

    public ArrayList<Integer> getX_interacao() {
        return X_interacao;
    }

    public ArrayList<Double> getY_custo() {
        return Y_custo;
    }
